class BootStrap {
    ...
    def init = { servletContext ->
       ...
       // new tweetassign_01.Message(acc: 1, msgText: '15 minutes can save you 15% or more').save()
        ...
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 2').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 3').save()//new tweetassign_01.Account(accountHandle: 'walter', fullName: 'nay na', emailAddress:'ab@com', accountPassword:'msse2016ASSIGN').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 4').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 5').save()
        ...
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 10').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 11').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 12').save()
        new tweetassign_01.Message(acc: 1, msgText: 'Hello World 13').save()//new tweetassign_01.Account(accountHandle: 'walter', fullName: 'nay na', emailAddress:'ab@com', accountPassword:'msse2016ASSIGN').save()
    }
    def destroy = {
    }
}
